      ...
      >
        ...
        <div className="about-grid">
          ...
          >
            ...
            <StaggerText
              inView={inView}
              text="93 батальйон ЗСУ спеціалізується на високоточному виявленні та гарантованому знищенні ворожої бронетехніки. Ми працюємо технологічно, швидко і безжально."
              style={{
