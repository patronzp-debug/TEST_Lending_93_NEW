...
export const VACANCIES: VacancyItem[] = [
  /* ── Водії та Техніка ── */
  {
    ...
    requirement: 'Права категорії B/C',
  ...
  },
  {
    ...
    category: 'Водії та Техніка',
    categoryEn: 'DRIVERS & MACHINERY',
    requirement: 'Права категорії B/C, підготовка з інженерних справ за наявністю',
  ...
  /* ── Медицина ── */
  {
    ...
    category: 'Медицина',
    categoryEn: 'MEDICINE',
    requirement: 'Медична освіта або базовий курс тактичної медицини за наявністью',
  ...
  /* ── Бойові Спеціальності ── */
  {
    ...
    requirement: 'Бажання працювати з противотанковими системами',
    shortDescription: 'Наведення та ведення вогню з противотанкових систем.',
    description: 'Наведення та ведення вогню з противотанкових систем. Обслуговування озброєння, підготовка боєприпасів.',
    span: 'wide',
    priority: 'КРИТИЧНО',
  ...
  },
  {
    ...
    category: 'Бойові Спеціальності',
    categoryEn: 'COMBAT SPECIALTIES',
    requirement: 'Фізична підготовка',
  ...
  /* ── Спеціалісти БПЛА/IT ── */
  {
    ...
    requirement: 'Досвід пілотування FPV або мультиротора від 6 міс. за наявністю ',
    shortDescription: 'Пілотування безпілотних літальних апаратів для розвідки та коригування.',
    description: 'Пілотування безпілотних літальних апаратів для ведення повітряної розвідки та коригування противотанкового вогню. Технічне обслуговування дронів, аналіз отриманих даних, взаємодія з бойовими підрозділами.',
    span: 'tall',
    priority: 'КРИТИЧНО',
  ...
  },
  {
    ...
    category: 'БПЛА / IT',
    categoryEn: 'SPECIALISTS (UAV/IT)',
    requirement: 'Досвід у сфері приготування їжі,середня спеціальна освіта, за наявністю',
