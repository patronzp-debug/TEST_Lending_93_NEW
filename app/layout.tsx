...
export const metadata: Metadata = {
  ...
  title: '93 батальйон ЗСУ — 93 ОПТБ | Рекрутинг',
  description:
    'Офіційний рекрутинговий портал 93 батальйону ЗСУ. 93 окремий протитанковий батальйон: вакансії, служба за контрактом та онлайн-заявка.',
  keywords: [
    '93 ОПТБ',
    '93 батальйон',
    '93 батальйон ЗСУ',
    '93 батальйон вакансії',
  ...
  openGraph: {
    title: '93 батальйон ЗСУ — 93 ОПТБ',
    description:
      'Офіційний рекрутинговий портал 93 батальйону ЗСУ: вакансії, служба за контрактом та онлайн-заявка.',
    url: '/',
    siteName: '93 батальйон ЗСУ',
    locale: 'uk_UA',
    type: 'website',
  },
  twitter: {
